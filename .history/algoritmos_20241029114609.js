...
function opBasicas(){
    ...
    console.log("El resultado de la suma es:  " + SU + "El resultado de la resta es:  " + R + "El resultado de la multiplicacion es:  " + M + "El resultado de la divicion es:  " + SU)
    alert("El resultado de la suma es:  " + SU)
